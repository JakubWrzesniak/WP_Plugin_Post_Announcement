                        ...
                        <tbody> 
                            <form id="new-announcement-form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post"> 
                                ...
                                <tr>
                                    ...
                                    <td><input required type="datetime-local" name="<?php echo "pa"; ?>[enddate]" id="enddate" value="<?php if(!empty($item) && isset($item['enddate'])){echo date('Y-m-d\Th:m:s', strtotime($item['enddate']));}; ?>"></td>    
                                </tr> 
                                <tr>
